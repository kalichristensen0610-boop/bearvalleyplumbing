...
export function Footer() {
  return <>
    <footer className="footer" id="contact">
      <div className="footer-brand"><Image src="/bear-river-logo-idaho-2026.png" width={1672} height={941} sizes="(max-width: 760px) 240px, 280px" alt="Bear River Plumbing LLC" /><p>Local, family-owned plumbing professionals serving homeowners, builders, and new-home projects across the communities we call home.</p></div>
