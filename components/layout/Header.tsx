...
export function Header(){
  ...
  return <>
    ...
    <header className={headerHidden?"site-header header-hidden":"site-header"}>
      <Link href="/" className="brand" aria-label="Bear River Plumbing home" onClick={closeMenus}><Image src="/bear-river-logo-idaho-2026.png" width={1672} height={941} alt="Bear River Plumbing LLC" priority sizes="(max-width: 760px) 132px, 170px" /></Link>
