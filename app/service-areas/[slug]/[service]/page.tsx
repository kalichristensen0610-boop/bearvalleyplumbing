...
export async function generateMetadata({params}:{params:Promise<{slug:string;service:string}>}):Promise<Metadata>{
  ...
  const description=`Request ${s.name.toLowerCase()} for homes and new-home projects in ${l.name}, ${l.state}. Local service information from Bear River Plumbing.`;
