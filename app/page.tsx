...
export const metadata = {
  title: "Idaho Plumbing",
  description: "Whole-house plumbing, water treatment, remodels, and new construction across Eastern Idaho and the Treasure Valley.",
};
  ...
  return <main>
    <section className="home-hero">
      ...
      <div className="home-hero-copy">
        <p className="eyebrow">Residential plumbing · Eastern Idaho & Treasure Valley</p>
        <h1>Plumbing made for Idaho.</h1>
        <p className="lead">Straight answers, dependable workmanship, whole-house plumbing services, water treatment, remodels, and new construction.</p>
    ...
    <TrustBar />
    <section className="section"><SectionHead eyebrow="What we do" title="Plumbing help for the whole home." lead="From everyday repairs and drain cleaning to water heaters, water treatment, kitchen and bath plumbing, and repiping, start with the service that best matches what you need." /><ServiceGrid items={services} /></section>
    <section className="split-section">
      ...
      <article className="dark"><p className="eyebrow">Water, pipes & drains</p><h2>Dependable systems from end to end.</h2><p>From water heaters and treatment systems to repiping and drain cleaning, we help keep the plumbing behind your walls working the way it should.</p><Link className="inline-link light" href="/services">Explore all plumbing services →</Link></article>
    </section>
    <section className="section why"><div><p className="eyebrow">Why Bear River</p><h2>Local service should feel personal.</h2></div><div className="why-list"><article><span>01</span><h3>Community minded</h3><p>We live and work in the Idaho communities we serve.</p></article><article><span>02</span><h3>Straight answers</h3><p>Clear conversations about the problem, the work, and the next step.</p></article><article><span>03</span><h3>Property respect</h3><p>Thoughtful work in homes and active construction sites.</p></article><article><span>04</span><h3>Built for projects</h3><p>Residential service plus coordinated plumbing for new home construction.</p></article></div></section>
    <section className="section areas-section">
      <SectionHead eyebrow="Service areas" title="Idaho roots. Regional reach." lead="Explore service areas across Eastern Idaho and the Treasure Valley." />
      <div className="service-map-layout">
        <div className="service-map-frame"><iframe name="service-area-map" title="Interactive Bear River Plumbing service area map" src={mapUrl("Eastern Idaho", "Idaho")} loading="lazy" referrerPolicy="no-referrer-when-downgrade" allowFullScreen /><p>Use the map controls to zoom and move around the region.</p></div>
